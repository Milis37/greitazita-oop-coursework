...
class FinancialReportBuilder:
    """Builder šablonas ataskaitoms generuoti (OOP reikalavimas)"""
    ...
    def add_summary(self) -> 'FinancialReportBuilder':
        ...
        current_month = datetime.now().strftime("%Y %B")   # pvz. "2026 April"
        ...
        if profit > 1500:
            ...
            self._report_lines.append("   📈 Geras pelnas. Tęskite taip pat!")
        elif profit > 0:
            self._report_lines.append("   ⚠️ Teigiamas pelnas, bet gali būti geriau.")
        else:
